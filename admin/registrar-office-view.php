  ...
  <div class="container mt-5">
    <div class="teacher-card shadow p-4">
      <div class="teacher-info">  
        <h3 class="mb-3"><?= $r_user['fname']." ".$r_user['lname']; ?></h3>
          ...
          <a href="registrar-office.php" class="btn btn-secondary">Go Back</a>
        </div>
      </div>
      <div class="teacher-photo text-center">
        <img src="../img/registrar-office-<?=$r_user['gender']?>.jpg" class="rounded-circle mb-2" alt="Reigstrar Office">
        <h5>@<?=$r_user['username']?></h5>
      </div>
    </div>
  </div>
     <?php 
