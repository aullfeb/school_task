...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="form-wrapper d-flex justify-content-center mb-3">
      <form method="post" class="form-content" action="req/registrar-office-edit.php">
        ...
        <div class="mb-3">
          ...
          <input type="radio" value="Male"
            <?php if($r_user['gender'] == 'Male') echo 'checked';  ?> name="gender"> Male
            &nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" value="Female"
            <?php if($r_user['gender'] == 'Female') echo 'checked';  ?> name="gender"> Female
        </div>
    ...
    <div class="form-wrapper d-flex justify-content-center">
     <form method="post" class="form-content" action="req/registrar-office-change.php" id="change_password">
       ...
       <div class="mb-3">
          ...
          <div class="input-group mb-3">
            ...
            <button class="gBtn" id="gBtn"> Random</button>
          </div>
        </div>
        <input type="text" value="<?=$r_user['r_user_id']?>" name="r_user_id" hidden> 
        <div class="mb-3">
