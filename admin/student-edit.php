...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="form-wrapper d-flex justify-content-center">
      <form method="post" class="form-content" action="req/student-edit.php">
        ...
        <div class="mb-3">
          ...
          <div class="row row-cols-5">
            ...
            ?>
            <div class="col">
              <input type="radio" name="section" <?php if($checked) echo "checked"; ?> value="<?=$section['section_id']?>"> <?=$section['section']?>
            </div>
            <?php } ?>              
          </div>
        </div>
    ...
    <div class="form-wrapper d-flex justify-content-center mt-3">
      <form method="post" class="form-content" action="req/student-change.php" id="change_password">
