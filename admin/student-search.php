  ...
  <div class="container mt-5">
    ...
    <form action="student-search.php" class="mt-3 n-table" method="get">
      <div class="input-group mb-3">
        <input type="text" class="form-control" name="searchKey" placeholder="Search..." autofocus>
        <button class="gBtn"> <i class="fa fa-search" aria-hidden="true"></i>
        </button>
      </div>
    </form>
    ...
    <?php }else{ ?>
      <div class="alert alert-info .w-450 m-5" role="alert" id="noResultBox">
        No Results Found
