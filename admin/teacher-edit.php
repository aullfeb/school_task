...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="form-wrapper d-flex justify-content-center">
      <form method="post" class="form-content mt-5 form-w" action="req/teacher-edit.php">
        ...
        <div class="mb-3">
          <label class="form-label">Qualification<div class="form-text text-muted">Bachelor / Diploma etc.</div></label>
        ...
        <div class="mb-3">
          ...
          <div class="row row-cols-5">
            <?php $subject_ids = str_split(trim($teacher['subjects']));
        ...
        <div class="mb-3">
          ...
          <div class="row row-cols-5">
            <?php $class_ids = str_split(trim($teacher['class']));
    ...
    <div class="form-wrapper mt-3 d-flex justify-content-center">
      <form method="post" class="form-content" action="req/teacher-change.php" id="change_password">
          ...
          <div class="mb-3">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control" name="new_pass" id="passInput">
                <button class="gBtn" style="border-radius: 5px;">
                  Random
                </button>
            </div>
          </div>
  ...
  <script>
    ...
    gBtn.addEventListener('click', function(e){ e.preventDefault();
      makePass(4);
    });
  </script>
